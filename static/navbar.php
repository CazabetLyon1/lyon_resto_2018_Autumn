...
<nav class="navbar navbar-expand-lg">
    ...
    <div class="form-inline my-2 my-lg-0" id="searchInMap">        
        <input class="form-control mr-sm-2" type="search" placeholder="type, address, review, ..." aria-label="Search" id="textSearch" >
        <button class="btn btn-success my-2 my-sm-0" type="button" id="searchButton"><span class="fa fa-search"></span></button>
    </div>

    <div class="collapse navbar-collapse" id="navbarContent">
        <ul class="navbar-nav mr-auto" id="button-group">
            ...
            <li class="nav-item divGear">
                <button type="button" class="btn" id="settings" data-toggle="modal" data-target="#modalSettings">Settings</button>
            </li>
        </ul>
