...
def request_detail(nom_fichier_entree="a.json",nom_fichier_resultat="b.json",nom_fichier_erreur="c.json",API_KEY='AIzaSyD4vq_bMskdNlprQ3D1_6g32S6IYNV_iQM'):
	...
	for resto in liste_resto:
		...
		#comme le programme tourne très longtemps (quelque heures) je fais une save tout les 50 appels ( ~ 22 au total) 
...
request_detail(nom_fichier_entree="C:/Users/franc/bars.json",nom_fichier_resultat="barsdetails.json",nom_fichier_erreur="erreurbardetails.json",API_KEY='AIzaSyD4vq_bMskdNlprQ3D1_6g32S6IYNV_iQM')